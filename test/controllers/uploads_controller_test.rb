...
class UploadsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create upload" do
    assert_difference('Upload.count') do
      post uploads_url, params: { upload: { checksum: @upload.checksum, filename: @upload.filename, filesize: @upload.filesize } }
    end
  ...
  test "should update upload" do
    patch upload_url(@upload), params: { upload: { checksum: @upload.checksum, filename: @upload.filename, filesize: @upload.filesize } }
